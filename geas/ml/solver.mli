...
val ivar_lt : intvar -> int -> Atom.t
val ivar_ge : intvar -> int -> Atom.t
val ivar_gt : intvar -> int -> Atom.t
val ivar_ne : intvar -> int -> Atom.t
val islice_lt : intslice -> int -> Atom.t
val islice_ge : intslice -> int -> Atom.t
val islice_gt : intslice -> int -> Atom.t
val fpvar_gt : fpvar -> float -> Atom.t
val fpvar_ge : fpvar -> float -> Atom.t
